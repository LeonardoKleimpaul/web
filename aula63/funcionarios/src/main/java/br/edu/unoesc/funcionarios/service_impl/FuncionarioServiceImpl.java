...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		repositorio.saveAll(List.of(
				...
				new Funcionario(null, "Marcelo Padaria", 2, new BigDecimal("42.42"), LocalDate.of(2001, 12, 28)),
	...
	@Override
	public Page<Funcionario> buscaPaginadaPorNome(String nome, 
												  Integer salario, 
			                                      Integer tamPagina, 
			                                      String campo,
			                                      String direcao) {
		PageRequest reqPagina = PageRequest.of(salario,
											   tamPagina,
